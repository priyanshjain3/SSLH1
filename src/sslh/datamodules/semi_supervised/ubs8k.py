...
class UBS8KSSLDataModule(LightningDataModule):
    def __init__(
        self,
        root: str = "/home/s3240630/data1/projets/samova/leocances/UrbanSound8K",
