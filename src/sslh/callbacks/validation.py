...
class ValidationCallback(Callback):
    ...
    def run(self, trainer: Trainer, pl_module: LightningModule) -> None:
        with torch.no_grad():
    ...
    # def run_validation(
    #     self, dataloader: DataLoader, pl_module: LightningModule
    # ) -> None:
    #     concat_scores = {}
    ...
    def run_validation(
        ...
        for batch in dataloader:
            ...
            print('Sample Predictions:', probs_xs[:5])
            print('True Labels:', ys[:5])
