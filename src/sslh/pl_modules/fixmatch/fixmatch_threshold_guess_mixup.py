...
class FixMatchThresholdGuessMixup(FixMatchMixup):
    def __init__(
        ...
        """
        FixMatch with Threshold Guess pseudo label and Mixup (FMTGM) LightningModule.
        ...
        self.save_hyperparameters({"threshold_guess": threshold_guess, "alpha": alpha})
